...
<%
	//for 문을 사용해서 freeboard 테이블의 값을 1000개 insert 
	String sql = null;
	...
	try{
		for (int i = 0; i< 1000; i++){
			...
			pstmt.setInt(1, i);      // index는 1번이고, id 필드의 값
			pstmt.setString(2, "이상혁 - " + i);
			pstmt.setString(3, "1234");
			pstmt.setString(4, "t1@t1.com - " + i);
		...
		out.println("DB에 1000번 값이 저장되었습니다.");
